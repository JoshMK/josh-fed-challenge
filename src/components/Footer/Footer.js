...
function Footer(props) {
  ...
  const ICONS = footerNavItems["icons"];
  const COPYWRITE = footerNavItems["copywrite"];
  return (
    <footer className="app__footer">
      ...
      <div className="app__footer-icons">
        ...
        >
          {ICONS.map((icon) => renderFooterSVG(icon))}
        </ul>
      </div>
